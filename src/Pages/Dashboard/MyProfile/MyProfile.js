...
const MyProfile = () => {
    ...
    const { data: users, isLoading, refetch } = useQuery(['users', user.email], () => fetch(`https://fast-beyond-75941.herokuapp.com/profile/${user.email}`, {
        method: 'GET',
        headers: {
    ...
    const onSubmit = data => {
        ...
        fetch(`https://fast-beyond-75941.herokuapp.com/profile/${user.email}`, {
            method: 'PUT',
            headers: {
