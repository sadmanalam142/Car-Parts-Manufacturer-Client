...
const Purchase = () => {
    ...
    const {data: items, isLoading, refetch} = useQuery('parts', () => fetch(`https://arcane-island-78808.herokuapp.com/part/${id}`).then(res => res.json()));
    ...
    const handleOrder = event => {
        ...
        fetch('https://arcane-island-78808.herokuapp.com/order', {
            method: 'POST',
            headers: {
        ...
        const url = `https://arcane-island-78808.herokuapp.com/part/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                'content-Type': 'application/json'
