...
const Purchase = () => {
    ...
    const {data: items, isLoading, refetch} = useQuery('parts', () => fetch(`https://car-parts-manufacturer-server.vercel.app/part/${id}`).then(res => res.json()));
    ...
    const handleOrder = event => {
        ...
        fetch('https://car-parts-manufacturer-server.vercel.app/order', {
            method: 'POST',
            headers: {
        ...
        const url = `https://car-parts-manufacturer-server.vercel.app/part/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                'content-Type': 'application/json'
